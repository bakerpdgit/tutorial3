class Person:
  def __init__(self, forename: str, surname: str, age: int = 0) -> None:
    ...
    # able to have children at the time they are born, so we remove the
    # children parameter from __init__
    ...
    # Default values for attributes can be set as default values for function
    # parameters
    self.age: int = age
    ...
    # so callers don't have to announce a birth every time they create a new
    # object.
