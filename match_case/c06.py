...
run_command(("authenticate", False, Authenticator("correct-horse-battery-staple")))
run_command(("authenticate", True, Authenticator("incorrect-donkey-generator-glue")))
run_command(("authenticate", True, Authenticator("correct-horse-battery-staple")))
advanced_authenticator = Authenticator("correct-horse-battery-staple")
advanced_authenticator.authenticate = lambda: print("Authenticated with advanced security")
...
run_command(("send", True, [Chunk(False, "in"), Chunk(False, "dignity"), Chunk(False, "in")]))
run_command(("send", True, {"data": [Chunk(True, "fair"), Chunk(False, "Verona"), Chunk(False, "where")]}))
run_command(("send", True, {"data": [Chunk(False, "we"), Chunk(False, "lay")], "count": 2}))
