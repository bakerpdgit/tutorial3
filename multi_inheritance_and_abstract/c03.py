...
class MoveBehaviour:
    ...
    def __init__(self, character: _Character) -> None:
        self.__character: _Character = _________ # we store the character so we can use it for calculations
...
class Player:
    ...
    # we pass in the class so we can instantiate it with the private character attribute
...
# we can make more move behaviours / attack behaviours and this code will still be the same
