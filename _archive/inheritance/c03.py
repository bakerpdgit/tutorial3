...
class GasGiant:
  ...
  def establish_orbital_base(self, height):
    ...
    print(
        f"The base orbits {height}m above the surface of the planet at a speed of {orbital_velocity}m/s")
...
class IceGiant:
  ...
  def establish_subsurface_base(self, depth):
    ...
    print(
        f"The base needs to be able to endure a pressure of approximately {pressure}Pa")
